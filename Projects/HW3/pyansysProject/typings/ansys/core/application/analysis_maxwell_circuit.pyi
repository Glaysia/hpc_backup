...
class AnalysisMaxwellCircuit(Analysis):
    ...
    """
    def __init__(self, application, project, design, version=..., non_graphical=..., new_desktop=..., close_on_exit=..., student_version=..., machine=..., port=..., aedt_process_id=..., remove_lock=...) -> None:
        ...
