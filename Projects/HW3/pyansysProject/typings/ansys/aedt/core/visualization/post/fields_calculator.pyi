...
class FieldsCalculator:
    ...
    def add_expression(self, calculation, assignment, name=...): # -> Any | Literal[False]:
    ...
    @pyaedt_function_handler()
    def create_expression_file(self, name, operations): # -> str | Literal[False]:
    ...
    @pyaedt_function_handler()
    def expression_plot(self, calculation, assignment, names, setup=...): # -> list[Any] | Literal[False]:
    ...
    @pyaedt_function_handler()
    def delete_expression(self, name=...): # -> Literal[True]:
    ...
    @pyaedt_function_handler()
    def is_general_expression(self, name): # -> bool:
    ...
    @pyaedt_function_handler()
    def load_expression_file(self, input_file): # -> dict[str, Any] | list[Any] | Any | DataFrame | dict[Any, Any] | Literal[False]:
    ...
    @pyaedt_function_handler()
    def validate_expression(self, expression): # -> dict[Any, Any] | Literal[False]:
    ...
    @pyaedt_function_handler()
    def calculator_write(self, expression, output_file, setup=..., intrinsics=...): # -> bool:
    ...
    @pyaedt_function_handler()
    def write(self, expression, output_file, setup=..., intrinsics=...): # -> bool:
        """Save the content of the stack register for future reuse in a later Field Calculator session.
    ...
    @pyaedt_function_handler()
    def evaluate(self, expression, setup=..., intrinsics=...): # -> Any | None:
    ...
    @pyaedt_function_handler()
    def export(self, quantity, solution=..., variations=..., output_file=..., intrinsics=..., phase=..., sample_points=..., export_with_sample_points=..., reference_coordinate_system=..., export_in_si_system=..., export_field_in_reference=..., grid_type=..., grid_center=..., grid_start=..., grid_stop=..., grid_step=..., is_vector=..., assignment=..., objects_type=...): # -> Literal[False]:
